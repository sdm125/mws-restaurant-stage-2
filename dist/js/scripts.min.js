  ...
  _createClass(DBHelper, null, [{
    ...
    value: function getLocalDatabase() {
      return idb.open('restaurant-reviews-data', 1, function (upgradeDb) {
        var store = upgradeDb.createObjectStore('restaurant-reviews', { keyPath: 'id' });
      });
    }
    ...
    value: function fetchRestaurants(callback) {
      var restaurantsData = fetch(DBHelper.DATABASE_URL).then(function (response) {
        if (!response.ok) {
          debugger;Error(response.statusText);
        }
        ...
        DBHelper.getLocalDatabase().then(function (db) {
          ...
          var restaurantsStore = tx.objectStore('restaurant-reviews');
